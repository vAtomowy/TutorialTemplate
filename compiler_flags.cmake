...
set(CXX_FLAGS "-std=gnu++11 -g -fno-rtti -fno-exceptions -fverbose-asm -MMD")
...
# fverbose-asm - additional comments for generated assembler code
# -MMD - create dependency files
set(C_FLAGS "-std=gnu99 -g -ffunction-sections -fdata-sections -fverbose-asm -MMD")
...
set(LD_SCRIPT ${CMAKE_SOURCE_DIR}/STM32L431RCTX_FLASH.ld)
# Linker flags
# -Wl, -Map - map file to be created
# -T - file with linker script
# -g - debug flag
# -Wl,--gc-sections - unused function removal
set(LD_FLAGS "-g -Wl,-Map=${PROJECT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map,--cref -T${LD_SCRIPT} -Wl,--gc-sections")
